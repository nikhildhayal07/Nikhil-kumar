...
export function About() {
  return (
    <section id="about-me" className="py-24 md:py-32 relative overflow-hidden">
              ...
              <div className="p-8 rounded-3xl bg-card border border-border relative overflow-hidden">
                ...
                <div className="flex items-start gap-6 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm mt-1">Building scalable cloud infrastructure that transforms ideas into impact.</p>
                  </div>
                </div>
